...
import {
    SynveltAnimationCurves,
    SynveltAnimationDurations,
} from '@synvelt/animations/defaults';
...
const fadeIn = trigger('fadeIn', [
    ...
    transition('void => *', animate('{{timings}}'), {
        params: {
            timings: `${SynveltAnimationDurations.entering} ${SynveltAnimationCurves.deceleration}`,
        },
    }),
]);
...
const fadeOut = trigger('fadeOut', [
    ...
    transition('* => void', animate('{{timings}}'), {
        params: {
            timings: `${SynveltAnimationDurations.exiting} ${SynveltAnimationCurves.acceleration}`,
        },
    }),
]);
