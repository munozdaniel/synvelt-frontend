...
import {
    FSDocument,
    FSDocumentElement,
} from '@synvelt/components/fullscreen/fullscreen.types';

@Component({
    selector: 'synvelt-fullscreen',
    templateUrl: './fullscreen.component.html',
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs: 'synveltFullscreen',
})
export class SynveltFullscreenComponent implements OnInit {
