...
export class SynveltNavigationService {
    private _componentRegistry: Map<string, any> = new Map<string, any>();
    private _navigationStore: Map<string, SynveltNavigationItem[]> = new Map<
        string,
        any
    >();
     ...
     * @param navigation
     */
    storeNavigation(key: string, navigation: SynveltNavigationItem[]): void {
        // Add to the store
     ...
     * @param key
     */
    getNavigation(key: string): SynveltNavigationItem[] {
     ...
     */
    getFlatNavigation(
        navigation: SynveltNavigationItem[],
        flatNavigation: SynveltNavigationItem[] = []
    ...
    getItemParent(
        id: string,
        navigation: SynveltNavigationItem[],
        parent: SynveltNavigationItem[] | SynveltNavigationItem
    ): SynveltNavigationItem[] | SynveltNavigationItem | null {
        for (const item of navigation) {
            if (item.id === id) {
                return parent;
            }
