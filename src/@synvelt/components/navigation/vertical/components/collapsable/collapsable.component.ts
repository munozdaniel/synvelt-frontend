...
@Component({
    selector: 'synvelt-vertical-navigation-collapsable-item',
    templateUrl: './collapsable.component.html',
    animations: synveltAnimations,
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SynveltVerticalNavigationCollapsableItemComponent
    implements OnInit, OnDestroy
{
    ...
    @HostBinding('class') get classList(): any {
        return {
            'synvelt-vertical-navigation-item-collapsed': this.isCollapsed,
            'synvelt-vertical-navigation-item-expanded': this.isExpanded,
        };
    }
    ...
    ngOnInit(): void {
        ...
        this._synveltVerticalNavigationComponent.onCollapsableItemCollapsed
        ...
        if (this.autoCollapse) {
            this._synveltVerticalNavigationComponent.onCollapsableItemExpanded
                .pipe(takeUntil(this._unsubscribeAll))
    ...
    collapse(): void {
        ...
        this._synveltVerticalNavigationComponent.onCollapsableItemCollapsed.next(
            this.item
        );
    }
    ...
    expand(): void {
        ...
        // Execute the observable
        this._synveltVerticalNavigationComponent.onCollapsableItemExpanded.next(
            this.item
        );
    }
