...
import { SynveltHighlightService } from '@synvelt/components/highlight/highlight.service';

@Component({
    selector: 'textarea[synvelt-highlight]',
    templateUrl: './highlight.component.html',
    styleUrls: ['./highlight.component.scss'],
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs: 'synveltHighlight',
})
export class SynveltHighlightComponent implements OnChanges, AfterViewInit {
    @Input() code: string;
    @Input() lang: string;
    ...
    constructor(
        ...
        private _synveltHighlightService: SynveltHighlightService,
    ...
    private _highlightAndInsert(): void {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(
            ...
            this._synveltHighlightService.highlight(this.code, this.lang)
        );
