...
import { SynveltMockApiReplyCallback } from '@synvelt/lib/mock-api/mock-api.types';

export class SynveltMockApiHandler {
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: SynveltMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: SynveltMockApiReplyCallback): void {
        // Store the reply
