...
import { SynveltMockApiUtils } from '@synvelt/lib/mock-api/mock-api.utils';
    ...
    registerHandlers(): void {
        ...
        this._synveltMockApiService
            ...
            .reply(({ request }) => {
                ...
                // Generate a new GUID
                newTag.id = SynveltMockApiUtils.guid();
        ...
        // @ Tasks - GET
        // -----------------------------------------------------------------------------------------------------
        this._synveltMockApiService.onGet('api/apps/tasks/all').reply(() => {
            // Clone the tasks
