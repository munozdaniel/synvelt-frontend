...
@Component({
  selector: 'app-filtro-preguntas',
  templateUrl: './filtro-preguntas.component.html',
})
export class FiltroPreguntasFrecuentesComponent implements OnInit, OnChanges {
  @Input() estadosEntidad: IEstadoEntidad[];
  @Input() cargando = false;
  @Input() estados: IEstadoEntidad[];
